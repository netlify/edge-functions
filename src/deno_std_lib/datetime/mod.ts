// Source: https://github.com/denoland/deno_std/blob/main/datetime/mod.ts
    ...
    switch (uniqueUnit) {
      ...
      case 'quarters':
        differences.quarters = Math.floor(
          (typeof differences.months !== 'undefined' && differences.months / 4) ||
            calculateMonthsDifference(bigger, smaller) / 4,
        )
        break
      case 'years':
        differences.years = Math.floor(
          (typeof differences.months !== 'undefined' && differences.months / 12) ||
