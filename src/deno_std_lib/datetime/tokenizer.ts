// Source: https://github.com/denoland/deno_std/blob/main/datetime/tokenizer.ts
...
export class Tokenizer {
  ...
  tokenize(string: string, receiver = (token: Token): ReceiverResult => token): ReceiverResult[] {
